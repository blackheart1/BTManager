...
* @version $Id: 3.0.0 config.php  2010-11-04 00:22:48 joeroberts $
...
if(!$row5 = $pmbt_cache->get_sql("search_cloud")){
	...
	if (!$search) die("Configuration not found! Make sure you have installed phpMyBitTorrent correctly.");
	if (!$row5 = $db->sql_fetchrow($search)) die("phpMyBitTorrent not correctly installed! Ensure you have run setup.php or config_default.sql!!");
