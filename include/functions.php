...
function btsqlerror($sql, $u_action = false) { //Returns SQL Error
        ...
        $msg .= "</p>";
								...
								$pa = debug_backtrace();
								$log = '<strong>' . basename( $pa[0]['file'] ) . '</strong> &nbsp; <font color="red">' . $pa[0]['line'] . "</font> &nbsp; <font color=\"green\">{$pa[0]['function']} ()</font> &nbsp; -- ". dirname( $pa[0]['file'] ). "/";//array_walk( $pa, create_function( '$a,$b', '"<b>". basename( $a[\'file\'] ). "</b> &nbsp; <font color=\"red\">{$a[\'line\']}</font> &nbsp; <font color=\"green\">{$a[\'function\']} ()</font> &nbsp; -- ". dirname( $a[\'file\'] ). "/";' ) );
