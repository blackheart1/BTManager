...
** File massupload.php 2018-02-23 14:32:00 Black_Heart
**
** CHANGES
**
...
switch ($do) {
						...
						else
						{
							...
							else
							{
								...
								else
								{
									...
									$sql = 'INSERT INTO '.$db_prefix."_massupload(
									`id` ,
									`name`
									)
									VALUES (
									NULL , '" . $db->sql_escape($table_info['NAME']) . "'
									);";
									$db->sql_query($sql);
	...
	$desc = $message_parser->message;
				...
				if(isset($shout))
				{
					$sql = 'INSERT INTO ' . $db_prefix . "_shouts (
						id, 
						user, 
						text, 
						posted, 
