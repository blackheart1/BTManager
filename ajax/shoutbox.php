...
* @version $Id: 3.0.0 ajax/shoutbox.php  2014-02-01 00:22:48 joeroberts $
...
{
global $db_prefix, $user, $db, $shout_config,$template,$btback1,$btback2, $phpEx,$shoutannounce, $config,$theme;
