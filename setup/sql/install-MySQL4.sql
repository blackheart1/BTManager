...
--
-- Host: localhost
-- Generation Time: May 11, 2013 at 04:16 PM
...
CREATE TABLE IF NOT EXISTS `#prefix#_bans` (
  ...
  `ban_email` varchar(100) binary NOT NULL,
  ...
  `reason` varchar(255) binary NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `#prefix#_users` (
  ...
  `clean_username` varchar(25) binary NOT NULL default '',
  `name` varchar(50) default NULL,
  ...
  `pm_popup` enum('true','false') NOT NULL,
  ...
  `can_do` varchar(225) binary NOT NULL default 'user',
  ...
  `newemail` varchar(255) binary default NULL,
  `mail_key` varchar(32) binary default NULL,
  ...
  `can_shout` enum('true','false') NOT NULL default 'true',
  `Show_online` enum('true','false') NOT NULL default 'true',
  ...
  `helper` enum('true','false') NOT NULL default 'false',
  `help_able` varchar(225) binary default NULL,
  `signature` varchar(200) binary NOT NULL,
  `bbcode_bitfield` varchar(255) binary NOT NULL,
  `bbcode_uid` varchar(8) binary NOT NULL,
  `sig_bbcode_bitfield` varchar(255) binary NOT NULL,
  `sig_bbcode_uid` varchar(8) binary NOT NULL,
  `forumbanned` enum('yes','no') NOT NULL default 'no',
  `parked` enum('true','false') NOT NULL default 'false',
  `disabled` enum('true','false') NOT NULL default 'false',
  `disabled_reason` text NOT NULL,
  `birthday` varchar(20) binary default NULL,
  `client` varchar(225) binary NOT NULL,
  `lastpage` varchar(225) binary NOT NULL,
  ...
  `user_dateformat` varchar(30) binary NOT NULL default 'd M Y H:i',
