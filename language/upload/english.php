...
$lang = array_merge($lang, array(
    ...
    'UPLOAD_OWNER_TYPE_EXP'     => '\'SHOW USER\' Allows other Users to see your Username,<br />\'PRIVACY MODE\' Hides it, retaining Edit/Delete Permissions,<br />\'STEALTH MODE\' (if available) Completely Hides the Owner to the System, and Doesn\'t Allow any Edit/Deletion by the User.',
    ...
    'LOCAL_TRACKER_DISABLED'  => 'Our Internal Tracker has been Disabled.  Only External Torrents can be Uploaded.',
    ...
    'MAX_UPLOADS_SET'  => 'You have already Uploaded your Maximum Daily Upload Quota (<b>%1$d</b>)',
    ...
    'INVALID_POSTER_TYPE'     => 'The Poster Filename you Entered is NOT a (gif|jpg|jpeg|png).',
    'INVALID_SCREEN_URL'      => 'The Link you Provided for your Poster is Invalid your Link must Start http://',
    'INVALID_SCREEN_TYPE'     => 'The Screenshot Filename you Entered is NOT a (gif|jpg|jpeg|png).',
    ...
    'FILTER_FAIL_INFO' => 'If you feel that you\'re getting this Message in Error.  Pplease contact the Administrator',
