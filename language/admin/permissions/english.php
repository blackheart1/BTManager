...
** File permissions/english.php 2018-02-28 12:15:00 Thor
**
** CHANGES
**
...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>These are used to Control Access on a Global Level and Apply to the Entire Site. They are further divided into User Permissions, Group Permissions, Global Moderators and Administrators Permissions.</p>

		<h2>Forum Based Permissions</h2>
		<p>These are used to Control Access on a Per Forum Basis. They are further divided into Forum Permissions, Forum Moderators, User and Group Forum Permissions.</p>
    ...
    'ROLE_DESCRIPTION_ADMIN_STANDARD'      => 'Has Access to most Administrator Functions but, is NOT Allowed to Use Server or System Related Tools.',
    ...
    'ROLE_DESCRIPTION_FORUM_FULL'          => 'Can Use ALL Forum Functions, Including Posting of Announcements and Stickies. Can also Ignore the Flood Limit.<br />NOT Recommended for Normal Users.',

    'ROLE_DESCRIPTION_FORUM_LIMITED'       => 'Can use some Forum Functions, but can NOT Attach Files or use Post Icons.',
    ...
    'ROLE_DESCRIPTION_FORUM_ONQUEUE'       => 'Can use most Forum Functions Including Attachments, but Posts and Topics need to be Approved by a Moderator.',

    'ROLE_DESCRIPTION_FORUM_POLLS'         => 'Like Standard Access but can also Create Polls.',
    'ROLE_DESCRIPTION_FORUM_READONLY'      => 'Can View the Forum, but can NOT Create New Topics or Reply to Posts.',
    'ROLE_DESCRIPTION_FORUM_STANDARD'      => 'Can use most Forum Functions Including Attachments and can Delete their Own Topics, but can NOT Lock their Own Topics, and can NOT Create Polls.',

    'ROLE_DESCRIPTION_FORUM_NEW_MEMBER'    => 'A Role for Members of the Special Newly Registered Users Group; contains <samp>NEVER</samp> Permissions to Lock Functions for New Users.',

    'ROLE_DESCRIPTION_MOD_FULL'            => 'Can use ALL Moderating Functions, Including Banning.',
    ...
    'ROLE_DESCRIPTION_USER_FULL'           => 'Can use ALL Available Forum Functions for Users, Including Changing the User Name and Ignore The Flood Limit.<br />NOT Recommended.',

    'ROLE_DESCRIPTION_USER_LIMITED'        => 'Can Access Some of the User Functions but, NOT Attachments, emails or Instant Messages.',

    'ROLE_DESCRIPTION_USER_NOAVATAR'       => 'Has a Limited Function Set, but is NOT Allowed to use the Avatar Feature.',
    'ROLE_DESCRIPTION_USER_NOPM'           => 'Has a Limited Function Set, but is NOT Allowed to use Private Messages.',
    'ROLE_DESCRIPTION_USER_STANDARD'       => 'Can Access most of the User Functions but can NOT Change User Name or Ignore the Flood Limit.',
    'ROLE_DESCRIPTION_USER_NEW_MEMBER'     => 'A Role for Members of the Special Newly Registered Users Group; contains <samp>NEVER</samp> Permissions to Lock Function for New Users.',
    ...
    'SELECT_FORUM_SUBFORUM_EXPLAIN' => 'The Forum you Select here will include all Sub Forums in the Selection.',
