...
** File permissions/english.php 2018-04-11 07:07:00 Thor
**
** CHANGES
**
...
$lang = array_merge($lang, array(
    ...
    <p>These are used to Control Access on a Global Level and Apply to the Entire Site.  They are further divided into User Permissions, Group Permissions, Global Moderator and Administrator Permissions.</p>
    ...
    <p>These are used to Create different Sets of Permissions for the different Permission Types, later being able to be Assigned on a Role Based Basis.  The Default Roles should cover the Administration of Site.  Within each of the Four Divisions, you can Add/Edit and Delete Roles as you see fit.</p>

    <h2>Permission Masks</h2>
    <p>These are used to View the Effective Permissions Assigned to Users, Moderators (Local and Global), Administrators for the Forums.</p><br />
    ...
    'ACL_VIEW_EXPLAIN' => 'Here you can see the Effective Permissions that the User/Group has.  A Green Square Indicates that the User/Group DOES have Permission.  A Pink Square Indicates that the User/Group DOES NOT have Permission.  A Red Square Indicates that the User/Group NEVER has Permission.',
    ...
    'ACP_FORUM_MODERATORS_EXPLAIN'  => 'Here you can Assign Users and Groups as Forum Moderators.  To Assign Users to Forums, Define Global Moderator Permissions or Administrators (please use the appropriate page).',
    ...
    'ACP_USERS_PERMISSIONS_EXPLAIN' => 'Here you can Assign Global Permissions to Groups - User Permissions, Global Moderator  and Administrator Permissions. <ul><li>User Permissions include the ability to use Avatars, Send Private Messages etc. <li>Global Moderator Permissions include the ability to Approve Posts, Manage Topics, Manage Bans etc.<li>Administrator Permissions include the ability to Alter Permissions, Define Custom BBCodes, Manage Forums etc.</ul>Individual User Permissions should ONLY be changed in Rare Occasions.  The Preferred Method is to put Users in Groups and Assigning the Groups Permissions.',
    ...
    'DELETE_ROLE_CONFIRM' => 'Are you sure you want to Remove this Role?  Users having this Role Assigned will <strong>NOT</strong> Loose their Permission Settings.',

    'DISPLAY_ROLE_ITEMS'  => 'View Users using this Role',
    ...
    'ROLE_ADMIN_USERGROUP'     => 'User and Group Administrator',
    ...
    'ROLE_FORUM_ONQUEUE'       => 'In Moderation Queue',
    ...
    'ROLE_DESCRIPTION_FORUM_FULL'      => 'Can use ALL Forum Features, including Posting of Announcements, Stickies and Ignore the Flood Limit.<br />NOT Recommended for Normal Users.',
    ...
    'ROLE_DESCRIPTION_EXPLAIN'         => 'You are able to Enter a Short Description for what this Role is used for.  The Text you Enter here will be Displayed within the Permissions Screens.',
