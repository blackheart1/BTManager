...
$lang = array_merge($lang, array(
    'WELCOME_MESSAGER'    => 'Welcome to the BTManager Conversion Tool!',
    ...
    'CONVERT_EXP'        => 'With this Tool you can Convert your Old Tracker Source over to BTManager<br />There are Several Steps to this and it will take time to complete.<br />In the First Step we will retrieve your Database Table Information for both BTManager and your previous Source.<br />Before we start we advise you to <strong>Back Up</strong> your Site, if not just Click Next!',
    ...
    'BUILD_EXP'        => 'We are going to Start Building a Conversion SQL to Import some Extra Information.<br />You will notice some of the Tables are Missing, this is because they are either NOT needed or will be addressed at a later point.<br />As we go through your Database Tables we will try to find some Matching Tables and Import the Information from them.<br />If we find a Table that matches but the Information inside is different we will walk you through Converting the Information Over.',
    ...
    'TORRENT_PATH_EXP'       => 'Enter the Path to your Old Torrents.',
    'TORRENT_TABL_NAME'      => 'Torrent Table',
    'TORRENT_TABL_NAME_EXP'  => 'Enter the Name of the Database Torrent Table',
    ...
    'TABLE_USE' => array(
        ...
        'PREFIX_acl_options'        => 'This Table contains Information regarding Permissions (\'can Read Forum\', \'can Post Topics\' etc.) are available.',
        ...
        'PREFIX_countries'          => 'List of Countries Users can select from their Profile.',
        ...
        'PREFIX_filter'             => 'Filter Table.  List of Keywords to Exclude in Uploads.',
        'PREFIX_forums'             => 'Forum Table.  Used for the Forum Topics and Forums.',
        'PREFIX_forums_access'      => 'Forum Access Table.  Lists Users in a Forum.',

        'PREFIX_forums_track'       => 'This Table keeps a Record for Visited Forums in Order to Mark them as Read or Unread.  We use the \'mark_time timestamp\' in conjunction with \'last post\' of Forum X\'s timestamp to know when ALL Topics in Forum X were Last Marked as Read. ',
        ...
        'PREFIX_icons'              => 'Icons Table.  List of Icons used for File Types',
        ...
        'PREFIX_modules'            => 'Modules Table.  List of Modules used for the Forum Moderator Section.',
