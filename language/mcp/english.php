...
*
* @package language
* @version $Id: mcp.php,v 1.6 2009/09/17 14:09:33 joerobe Exp $
...
$lang = array_merge($lang, array(
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'Using the form below you can merge selected posts into another topic. These posts will not be reordered and will appear as if the users posted them to the new topic.<br />Please enter the destination topic id or click on &uml;Select topic&tilde; to search for one.',
