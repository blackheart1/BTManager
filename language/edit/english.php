...
** File edit/english.php 2018-03-10 10:04:00 Thor
**
** CHANGES
**
...
$lang = array_merge($lang, array(
    ...
    'DESCRIPTION_EXPLAIN'     => 'Enter your Message, it may contain NO more than 60000 Characters. ',
    ...
    'ERROR_NOT_AUTH_EDCOM'    => 'You are NOT Authorized to Edit your Comments',
    'ERROR_NOT_AUTH_MDCOM'    => 'You are NOT Authorized to Edit others Comments',
    'ERROR_COMMENT_BLANK'     => 'Your Comment can NOT be Blank.  If you which to Remove your Comment, please Delete it',
    'ERROR_NOT_U_AUTH_EDIT'   => 'Your Group is NOT Authorized to Edit their Torrents',
    'ERROR_NOT_M_AUTH_EDIT'   => 'Your Group is NOT Authorized to Edit Torrents',
    'ERROR_NOT_U_AUTH_DELETE' => 'Your Group is NOT Authorized to Delete their Torrents',
    'ERROR_NOT_M_AUTH_DELETE' => 'Your Group is NOT Authorized to Delete Torrents',
    'ERROR_NOT_M_AUTHE_BAN'   => 'Your Group is NOT Authorized to Ban Torrents',
    'SUCCES_EDIT_TAKEN'       => 'Your Edit was Successfully Added',
    ...
    'EDIT_EVIDENT'            => 'Sticky',
    'EDIT_EVIDENT_EXP'        => 'Mark Torrent as Sticky so that is keeps it on the Top of the List.',
    'EDIT_PRIVACY'            => 'Display Name',

    'EDIT_PRIVACY_EXP'        => '<br /><strong>SHOW USER</strong> Allows other Users to see your User Name, <br />
